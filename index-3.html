...
<header class="header fullscreen" style="background-image: url('/dist/images/slides/05.jpg');">
...
<footer class="footer footer-small section">
	<div class="container">
		<div class="row text-center">
			<div class="col-12">
				<ul class="accepted-payments">
					<li><a href="#!"><i class="bx bxl-visa"></i></a></li>
					<li><a href="#!"><i class="bx bxl-mastercard"></i></a></li>
					<li><a href="#!"><i class="bx bxl-stripe"></i></a></li>
					<li><a href="#!"><i class="bx bxl-paypal"></i></a></li>
				</ul>
				<p>
					© Copyright 2016-2020. All Rights Reserved.
					<br>
					Created by <a href="https://hussam3bd.com" class="effect">Hussam Abd</a>
				</p>
				<ul class="social">
...
<div class="overlay overlay-simplegenie">
	...
	<div class="container">
		<div class="row text-center position-relative">
			<div class="col-md-7 col-xs-11 m-auto col-height-center search-form">
