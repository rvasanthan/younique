			...
			<div class="list-select">
				<div class="inner-select">
					<div class="selected pt-1">
						<img src="/dist/images/flags/uk.svg" width="18" alt="">
					</div>
					<ul>
						<li>
							<a href="index.html">
						...
						<li>
							<a href="rtl/">
								<img src="/dist/images/flags/sa.svg" width="18" alt="">
							</a>
						</li>
					</ul>
				</div>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-white">
		<div class="container">
			<a class="navbar-brand" href="index.html">
				<img src="/dist/images/logo.png" alt="Sham Theme">
			</a>
				...
				<li class="nav-item mr-3 shopping-cart">
					...
					<div class="dropdown-menu dropdown-menu-right border-0 shadow">
						<ul class="dropdown-wrap position-relative" data-slimscroll="true">
							<li class="d-flex">
								<a href="product.html">
									<img src="/dist/images/products/2.jpg" class="img-fluid product-img" alt="">
								</a>
							...
							<li class="d-flex">
								<a href="product.html">
									<img src="/dist/images/products/24.jpg" class="img-fluid product-img" alt="">
								</a>
								<div class="ml-3 product-details">
									<p class="product-title font-weight-bold text-uppercase mb-2">
							...
							<li class="d-flex">
								<a href="product.html">
									<img src="/dist/images/products/3.jpg" class="img-fluid product-img" alt="">
								</a>
								<div class="ml-3 product-details">
									<p class="product-title font-weight-bold text-uppercase mb-2">
							...
							<li class="d-flex">
								<a href="product.html">
									<img src="/dist/images/products/12.jpg" class="img-fluid product-img" alt="">
								</a>
								<div class="ml-3 product-details">
									<p class="product-title font-weight-bold text-uppercase mb-2">
		...
		<div class="swiper-wrapper text-center">
			...
			<div class="swiper-slide">
				<div class="d-flex align-items-center">
					<img src="/dist/images/slides/01.jpg" class="img-fluid" alt="">
				</div>
			</div>
			<div class="swiper-slide">
				<div class="d-flex align-items-center">
					<img src="/dist/images/slides/02.jpg" class="img-fluid" alt="">
				</div>
			</div>
			<div class="swiper-slide">
				<div class="d-flex align-items-center">
					<img src="/dist/images/slides/03.jpg" class="img-fluid" alt="">
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 collection">
				<a href="#!">
					<img src="/dist/images/collections/01.jpg" class="img-fluid" alt="">
				</a>
			</div><!-- /.collection -->
			<div class="col-md-6">
				<div class="row">
					<div class="col-md-6 collection">
						<a href="#!">
							<img src="/dist/images/collections/02.jpg" class="img-fluid" alt="">
						</a>
					</div><!-- /.collection -->
					<div class="col-md-6 collection">
						<a href="#!">
							<img src="/dist/images/collections/03.jpg" class="img-fluid" alt="">
						</a>
					</div><!-- /.collection -->
					<div class="col-sm-12 collection">
						<a href="#!">
							<img src="/dist/images/collections/04.jpg" class="img-fluid" alt="">
						</a>
					</div><!-- /.collection -->
				</div>
			</div>
				...
				<div class="masonry row">
					<div class="product col-lg-4 col-md-6" data-product-id="1">
						<div class="inner-product">
							...
							<div class="product-thumbnail">
								<img src="/dist/images/products/2.jpg" class="img-fluid" alt="">
							</div>
					...
					<div class="product col-lg-4 col-md-6" data-product-id="1">
						<div class="inner-product">
							...
							<div class="product-thumbnail">
								<img src="/dist/images/products/3.jpg" class="img-fluid" alt="">
							</div>
							<div class="product-details text-center">
								<div class="product-btns">
										<span data-toggle="tooltip" data-placement="top" title="Add To Cart">
					...
					<div class="product col-lg-4 col-md-6" data-product-id="1">
						<div class="inner-product">
							<div class="product-thumbnail">
								<img src="/dist/images/products/4.jpg" class="img-fluid" alt="">
							</div>
							<div class="product-details text-center">
								<div class="product-btns">
										<span data-toggle="tooltip" data-placement="top" title="Add To Cart">
					...
					<div class="product col-lg-4 col-md-6" data-product-id="1">
						<div class="inner-product">
							...
							<div class="product-thumbnail">
								<img src="/dist/images/products/1.jpg" class="img-fluid" alt="">
							</div>
							<div class="product-details text-center">
								<div class="product-btns">
										<span data-toggle="tooltip" data-placement="top" title="Add To Cart">
				...
				<ul>
					<li>
						<a href="https://www.instagram.com/p/BDX1oYbxJCK" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/01.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BDYTCedxJOb" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/02.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BDVyuQexJOq" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/03.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BDOJbBzRJIl" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/04.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BDIsqHGxJAn" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/05.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BDIUMb8RJFN" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/06.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BDGvWUXxJI_" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/07.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BDF7EqhRJND" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/08.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BC-Px3FxJEy" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/09.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BC5BAvnRJHV" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/10.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BC2WyRZxJJU" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/11.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BCyE0F6xJDM" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/12.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BCamzh5xJHR" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/13.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BCXvOLBxJDE" target="_blank">
							<span
									style="background-image: url('/dist/images/instagram/14.jpg')"></span>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/p/BDX1oYbxJCK" target="_blank">
